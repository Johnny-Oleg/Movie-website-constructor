...
(function() {
  var createFooter, createHeader, createMain, getElement, movieConstructor, movieData;
  ...
  createHeader = ({header, title}) => {
    var $container, $header, $logo, $menuBtn, $nav, $socialWrapper, $wrapper, logo, menu, menuLink, social, socialArr;
    ...
    if (menu) {
      ...
      $menuBtn.addEventListener('click', () => {
        ...
        return $wrapper.classList.toggle('header-active');
      });
      $nav.append(...menuLink);
      $wrapper.append($nav);
  ...
  createMain = ({title, main}) => {
    var $arrow, $block, $container, $content, $description, $genre, $main, $number, $slider, $star, $stars, $swiperBlock, $swiperWrapper, $title, $wrapper, $youtubeIcon, $youtubeImg, $youtubeLink, description, genre, i, rating, slider, slides, trailer;
    ...
    if (trailer) {
      $youtubeLink = getElement('a', ['button', 'youtube-modal', 'animated', 'fadeInRight'], {
        href: trailer,
    ...
    if (slider) {
      ...
      slides = slider.map(((item) => {
        var $card, $cardDescription, $cardImg, $swiper;
...
${item.title ? `<p class='card-title'>${item.title}</p>` : ''}`;
  ...
  createFooter = ({footer}) => {
    var $container, $content, $copyright, $footer, $leftBlock, $nav, $rightBlock, copyright, menu, menuLink;
  ...
  movieConstructor = (selector, options) => {
    var $app, $favicon, footer, header, index, main, type;
    ...
    options.subColor && document.documentElement.style.setProperty('--sub-color', options.subColor);
    if (options.favicon) {
